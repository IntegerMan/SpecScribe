...
public static class HtmlTemplater
{
    ...
    public static string RenderPage(DocModel doc, SiteNav nav, EntityPager? pager = null, QuickDevPageChrome? quickDev = null)
    {
        ...
        sb.Append(SiteNav.RenderBreadcrumb(doc.OutputRelativePath, BuildDocCrumbs(doc, quickDev)));
