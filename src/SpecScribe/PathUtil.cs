...
public static class PathUtil
{
    ...
    /// The status legend is on-demand beside status surfaces (<see cref="StatusStyles.LegendKey"/>), not footer chrome.
    ...
    /// [Story 4.8 Task 5; About polish]</summary>
    ...
    private static readonly Regex TagStripRegex = TimedRegex.New("<.*?>", RegexOptions.Compiled | RegexOptions.Singleline);
