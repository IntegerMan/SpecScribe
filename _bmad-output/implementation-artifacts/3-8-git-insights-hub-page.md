...
- [ ] Task 2: Render the hub page (AC: #1)
  ...
  - [ ] Subtask 2.3: Add a nav/breadcrumb entry point (e.g. a "Git" link) and a "View all git insights →" link from the consolidated dashboard Git Pulse panel (part of Story 3.1's consolidation), both guarded on the page existing.
