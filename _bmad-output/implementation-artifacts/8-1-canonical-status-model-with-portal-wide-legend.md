...
- **This is not the glossary.** Epic 10 Story 10.3 (FR29) owns the full "how to read this portal" glossary/orientation page. 8.1's legend explains the **status lifecycle stages only**. Keep it a focused status key, not a general glossary — 10.3 can later link to or absorb it. Do **not** build a standalone glossary page here.
